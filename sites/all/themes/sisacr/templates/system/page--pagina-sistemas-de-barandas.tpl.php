...
<header class="header" role="banner">
  ...
  <?php if ($logo): ?>
    <a href="<?php print $front_page; ?>" title="<?php /*print t('Home');*/ echo "Suministros para la industria en Costa Rica"; ?>" rel="home" id="logo">
...
<div class="main-content">
  ...
  <?php endif; ?>
    ...
    <div class="main" role="main">
      ...
      <?php if ($title): ?><h2 class="section-baranda-detalle-title" id="section-baranda-detalle-title">Nuestros <strong>Productos</strong></h2><?php endif; ?>
 ...
 <?php /*if ($title): ?><h1 class="title" id="page-title"><?php print $title; ?></h1><?php endif;*/ ?>
      ...
      <!-- obtener el atributo title -->
      <?php if(!drupal_is_front_page()){ ?>
        <?php 
          $field_meta_title = field_get_items('node', $node, 'field_meta_title');
        ?>
        <?php if ($title): ?><h1 class="title" id="page-title" title="<?php echo (!empty($field_meta_title[0]['value'])) ? $field_meta_title[0]['value'] : ''?>"><?php print $title; ?></h1><?php endif; ?>
      <?php }?>  
